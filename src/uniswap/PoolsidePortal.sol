...
/// @author Portals.fi
/// @notice This contract adds or removes liquidity to/from Poolside-like pools using any ERC20 token,
...
import { IBasicButtonswapRouter } from
    "./interface/IBasicButtonswapRouter.sol";
import { IUniswapV2Pair } from "./interface/IUniswapV2Pair.sol";

contract PoolsidePortal is Owned, Pausable {
    ...
    /// @notice Add liquidity to Poolside-like pools with network tokens/ERC20 tokens
    ...
    /// @param router The Poolside-like router to be used for adding liquidity
    ...
    /// @param router The Poolside-like router to use for the swap
