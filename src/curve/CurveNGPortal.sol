...
/// @author Portals.fi
/// @notice This contract adds liquidity to Curve StableSwapNG-like pools using any ERC20 token,
...
import { ICurveStableSwapNG } from
    "./interface/ICurveStableSwapNG.sol";

contract CurveNGPortal is Owned, Pausable {
    using SafeTransferLib for address;
    using SafeTransferLib for ERC20;

    constructor(address admin) Owned(admin) { }

    /// @notice Add liquidity to Curve StableSwapNG-like pools with network tokens/ERC20 tokens
    ...
    /// @param poolAddress The Curve-like pool address
    ...
    function portalIn(
        ...
        pool.add_liquidity(amounts, 0, recipient);
    }
